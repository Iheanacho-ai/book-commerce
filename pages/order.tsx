...
interface BagProps {
  session: any; // Update the type of session according to your requirements
}

const Bag = ({ session }: BagProps) => {
  ...
  return (
    <div className="bag">
      <div className="bag">
        <div className="py-14 px-4 md:px-6 2xl:px-20 2xl:container 2xl:mx-auto font-mono">
